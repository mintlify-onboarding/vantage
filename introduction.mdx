...
<CardGroup cols={3}>
  <IntroCard img="/images/docs-site-card-integrations.jpg" title="Quickstart">
    Get started creating an integration with a number of cloud and cloud service
    providers.
  </IntroCard>
  <IntroCard
    img="/images/docs-site-card-cloud-cost-report.jpg"
    title="Cost Reports"
  >
  ...
  <IntroCard
    img="/images/docs-site-card-terraform.jpg"
...
<CardGroup cols={3}>
  <IntroCard img="/images/docs-site-card-api.jpg" title="API Documentation">
  ...
  <IntroCard img="/images/docs-site-card-ec2.jpg" title="EC2Instances.info">
  ...
  <IntroCard
    img="/images/docs-site-card-handbook.jpg"
  ...
  <IntroCard img="/images/docs-site-card-slack.jpg" title="Slack Community">
