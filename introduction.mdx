...
<CardGroup cols={2}>
  <Card href="href">
    <div className="integration-logo">
      <img
        src="/images/docs-site-card-integrations.jpg"
        style={{ marginBottom: '20px' }}
      />
    </div>
    <h2 className="font-semibold text-base">Quickstart</h2>
    <p>
      Get started creating an integration with a number of cloud and cloud
      service providers.
    </p>
  </Card>
  <Card href="href">
    <div className="integration-logo">
      <img
        src="/images/docs-site-card-cloud-cost-report.jpg"
        style={{ marginBottom: '20px' }}
      />
    </div>
  ...
  <Card href="href">
    <div className="integration-logo">
      <img
        src="/images/docs-site-card-terraform.jpg"
        style={{ marginBottom: '20px' }}
      />
    </div>
...
<CardGroup cols={2}>
  <Card href="href">
    <div className="integration-logo">
      <img
        src="/images/docs-site-card-api.jpg"
        style={{ marginBottom: '20px' }}
      />
    </div>
    ...
    <p>
      ...
      reporting resources, as well as programmatically create reports and
      filters. View the API docs to get started.
    </p>
  </Card>
  <Card href="href">
    <div className="integration-logo">
      <img
        src="/images/docs-site-card-ec2.jpg"
        style={{ marginBottom: '20px' }}
      />
    </div>
  ...
  <Card href="href">
    ...
    <p>
      ...
      provides this anonymized and aggregated data to the community to shed
      light on cloud infrastructure costs.
    </p>
  </Card>
  <Card href="href">
    <div className="integration-logo">
      <img
        src="/images/docs-site-card-handbook.jpg"
        style={{ marginBottom: '20px' }}
      />
    </div>
  ...
  <Card href="href">
    <div className="integration-logo">
      <img
        src="/images/docs-site-card-slack.jpg"
        style={{ marginBottom: '20px' }}
      />
    </div>
