...
## Cross-Account IAM Roles on AWS[](#cross-account-iam-roles-on-aws "Direct link to Cross-Account IAM Roles on AWS")
...
### Customizing Cross-Account Role Permissions[](#customizing-cross-account-role-permissions "Direct link to Customizing Cross-Account Role Permissions")
...
## Data Revocation[](#data-revocation "Direct link to Data Revocation")
...
## Data Sharing[](#data-sharing "Direct link to Data Sharing")
...
<Accordion
    title="Does Vantage periodically perform penetration tests?"
>
    Yes. Vantage has outsourced penetration tests to a third party that regularly performs these tests.
</Accordion>
<Accordion
    title="Does Vantage hold any security certifications, such as SOC 2 or ISO 27001?"
>
...
<Accordion
    title="In terms of application security, how does Vantage deal with security reports received from security researchers? In other words, does Vantage have a bug bounty program or a straightforward process to report security issues?"
>
...
<Accordion
    title="Does Vantage support 2FA, SSO, or any defensive options?"
>
